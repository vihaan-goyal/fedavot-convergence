...
\begin{abstract}
Minibatch stochastic gradient descent (SGD) is group-blind: which groups
...
shows the two crossing where the decomposition predicts. A mean--conditional-value-at-risk (CVaR) layer
