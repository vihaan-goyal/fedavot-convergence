...
\end{proposition}
\noindent (Proof in the extended version.) The choice of $p$ is thus decorative
...
\begin{tikzpicture}[
   node distance=1.2mm,
   grp/.style={draw,rounded corners=1pt,minimum width=9mm,minimum height=3.4mm,font=\scriptsize,fill=Periwinkle!20},
   atm/.style={draw,rounded corners=1pt,minimum width=13mm,minimum height=3.4mm,font=\scriptsize,fill=YellowOrange!20},
...
by flow duality (proofs in the extended version).
...
\midrule
Adult, $\nu{=}.60$ & $\best{0.2269}$ & $0.2479$ & $0.2288$ & -- & $0.2073$ \\
Adult, $\nu{=}0$   & $0.2075$ & $0.2077$ & $0.2075$ & -- & $0.2073$ \\
IMDb, $\nu{=}.31$  & $\best{86.06}$ & $91.63$ & $86.74$ & $94.28$ & $82.95$ \\
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figs/severity_imdb.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figs/rare_group_fit.pdf}
...
$.035$ aligned, matching full. On IMDb-Wiki the top-importance identities show the crossover of
...
the sign flips where $\Delta_{\mathrm{floor}}$ crosses it. Adult skews: extended version.}
\label{tab:severity}
...
$\nu{=}.88$, extended version). Transport still concentrates weight on a starved
...
(per-race table in the extended version). On the least represented group the layer
...
% appendix removed: ICASSP allows references only on page 5; see main_full.tex
\end{document}
