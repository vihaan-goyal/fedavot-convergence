...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.68\linewidth]{imdbwiki_infeasible_K3_4000rounds_decay.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.86\linewidth]{adult_race_K3_4000rounds_decay.pdf}
...
uniform average worse still at $0.189$ and $0.119$). In the aligned regime
