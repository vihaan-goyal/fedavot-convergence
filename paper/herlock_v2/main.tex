...
steps, $5$ seeds, tail-500 statistics. Availability rates $r$ are swept through a
family indexed by $\beta$, from prevalence-proportional to importance-aligned
...
observation rates are non-uniform and is far off when they are uniform.}
\label{tab:overall}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.99\columnwidth]{figs/severity_imdb.pdf}
...
availability, $0.2269$ against $0.2479$ ($t{=}40$), and both IMDb cells,
$86.06$ against $91.63$ ($t{=}19$) and $84.28$ against $86.37$ ($t{=}11$). On
...
\midrule
$0$   & $.31$ & $6.99$ & $\best{+5.57}$ & $18.5$ \\
$0.5$ & $.59$ & $5.71$ & $\best{+3.46}$ & $10.1$ \\
$1.0$ & $.70$ & $3.67$ & $\best{+2.05}$ & $4.9$ \\
$1.5$ & $.77$ & $2.56$ & $+0.58$ & $1.0$ \\
$2.0$ & $.82$ & $1.62$ & $-0.03$ & $-0.1$ \\
$3.0$ & $.88$ & $0.02$ & $-2.28$ & $-7.1$ \\
\bottomrule
\end{tabular}
\end{table}
...
floor. On IMDb-Wiki the gain is
