...
fig.savefig(f"figures/imdbwiki_cvar_feasible_K{K}_{ROUNDS}rounds.png", dpi=140, bbox_inches="tight")
fig.savefig(f"figures/imdbwiki_cvar_feasible_K{K}_{ROUNDS}rounds.pdf", bbox_inches="tight")
print(f"saved figures/imdbwiki_cvar_feasible_K{K}_{ROUNDS}rounds.png")
