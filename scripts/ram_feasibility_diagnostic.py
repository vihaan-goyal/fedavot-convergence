...
fig.suptitle("FedAVOT in the restricted-availability (RAM) setting of arXiv:2309.14176",
             fontsize=13)
fig.tight_layout()
fig.savefig("figures/ram_feasibility_diagnostic.png", dpi=140, bbox_inches="tight")
fig.savefig("figures/ram_feasibility_diagnostic.pdf", bbox_inches="tight")
print("saved figures/ram_feasibility_diagnostic.png/.pdf and data/ram_feasibility.npz")
