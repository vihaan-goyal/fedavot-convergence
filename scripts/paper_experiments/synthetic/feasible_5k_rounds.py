...
fig.savefig(f"figures/2026-07-11_feasible_5k/fedavot_feasible_alpha{ALPHA}_{ROUNDS}rounds.png", dpi=140, bbox_inches="tight")
fig.savefig(f"figures/2026-07-11_feasible_5k/fedavot_feasible_alpha{ALPHA}_{ROUNDS}rounds.pdf", bbox_inches="tight")
print(f"saved figures/2026-07-11_feasible_5k/fedavot_feasible_alpha{ALPHA}_{ROUNDS}rounds.png")
