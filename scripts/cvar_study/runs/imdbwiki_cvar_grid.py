...
fig.savefig(f"figures/2026-07-11_cvar_study/imdbwiki_cvar_grid_K{K}_{ROUNDS}rounds.png", dpi=140, bbox_inches="tight")
fig.savefig(f"figures/2026-07-11_cvar_study/imdbwiki_cvar_grid_K{K}_{ROUNDS}rounds.pdf", bbox_inches="tight")
print(f"saved figures/2026-07-11_cvar_study/imdbwiki_cvar_grid_K{K}_{ROUNDS}rounds.png")
