...
# Usage (repo root): .venv/Scripts/python.exe scripts/pipeline/plot_severity_col.py
import csv, os
...
fig.savefig("paper/gavot_draft/figs/severity_col.pdf")
fig.savefig("paper/gavot_draft/figs/severity_col.png", dpi=200)
print("wrote paper/gavot_draft/figs/severity_col.{pdf,png}")
