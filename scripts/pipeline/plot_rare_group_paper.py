# Paper Fig. 2: loss on the least represented groups, decaying stepsize, from figures/2026-09-17_rare_group/rare_group_table.csv.
...
# Usage (repo root): .venv/Scripts/python.exe scripts/pipeline/plot_rare_group_paper.py
import csv, os
...
rare = list(csv.DictReader(open("figures/2026-09-17_rare_group/rare_group_table.csv")))
...
os.makedirs("paper/gavot_draft/figs", exist_ok=True)
fig.savefig("paper/gavot_draft/figs/rare_group_fit.pdf")
fig.savefig("paper/gavot_draft/figs/rare_group_fit.png", dpi=200)
print("wrote paper/gavot_draft/figs/rare_group_fit.{pdf,png}")
