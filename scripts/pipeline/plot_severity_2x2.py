...
# Usage (repo root): .venv/Scripts/python.exe scripts/pipeline/plot_severity_2x2.py
import csv, os
...
rows = list(csv.DictReader(open("figures/2026-09-14_severity_sweep/severity_sweep_table.csv")))
...
fig.savefig("paper/gavot_draft/figs/severity_2x2.pdf")
fig.savefig("paper/gavot_draft/figs/severity_2x2.png", dpi=200)
print("wrote paper/gavot_draft/figs/severity_2x2.{pdf,png}")
