...
# Usage (repo root): .venv/Scripts/python.exe scripts/pipeline/plot_severity_1x4.py
import csv, os
...
fig.savefig("paper/gavot_draft/figs/severity_1x4.pdf")
fig.savefig("paper/gavot_draft/figs/severity_1x4.png", dpi=200)
print("wrote paper/gavot_draft/figs/severity_1x4.{pdf,png}")
